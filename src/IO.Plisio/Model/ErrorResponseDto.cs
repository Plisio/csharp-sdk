...
namespace IO.Plisio.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorResponseDto :  IEquatable<ErrorResponseDto>, IValidatableObject
    {
        /// <summary>
        ...
        public ErrorResponseDto(string status = default(string), ErrorDto data = default(ErrorDto))
        {
            this.Status = status;
            this.Data = data;
        }
