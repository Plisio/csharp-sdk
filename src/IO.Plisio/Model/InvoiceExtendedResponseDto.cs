...
namespace IO.Plisio.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InvoiceExtendedResponseDto : InvoiceSimpleResponseDto,  IEquatable<InvoiceExtendedResponseDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceExtendedResponseDto" /> class.
        /// </summary>
        ...
        /// <param name="viewKey">invoice read-only view key.</param>
        public InvoiceExtendedResponseDto(
        ...
        /// </summary>
        /// <value>invoice read-only view key</value>
        [DataMember(Name="view_key", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as InvoiceExtendedResponseDto);
        }

        /// <summary>
        /// Returns true if InvoiceExtendedResponseDto instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceExtendedResponseDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceExtendedResponseDto input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.ViewKey == input.ViewKey ||
                    (this.ViewKey != null &&
                    this.ViewKey.Equals(input.ViewKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ViewKey != null)
                    hashCode = hashCode * 59 + this.ViewKey.GetHashCode();
                return hashCode;
            }
        }
