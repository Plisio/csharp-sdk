...
namespace IO.Plisio.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FeePlanTonDto : FeePlanCommonDto,  IEquatable<FeePlanTonDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeePlanTonDto" /> class.
        /// </summary>
        /// <param name="value">Fee value.</param>
        /// <param name="feeUnit">Fee unit.</param>
        public FeePlanTonDto(
        ...
        {
            return this.Equals(input as FeePlanTonDto);
        }

        /// <summary>
        /// Returns true if FeePlanTonDto instances are equal
        /// </summary>
        /// <param name="input">Instance of FeePlanTonDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeePlanTonDto input)
        {
            if (input == null)
                return false;
