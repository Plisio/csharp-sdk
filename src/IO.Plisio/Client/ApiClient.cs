...
namespace IO.Plisio.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = IO.Plisio.Client.Configuration.Default;
            RestClient = new RestClient("https://plisio.net/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://plisio.net/api/v1).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? IO.Plisio.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://plisio.net/api/v1")
        {
