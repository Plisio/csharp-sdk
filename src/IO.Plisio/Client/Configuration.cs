...
namespace IO.Plisio.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Plisio/1.0.0/csharp";
            BasePath = "https://plisio.net/api/v1";
        ...
        public Configuration(
            ...
            string basePath = "https://plisio.net/api/v1") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Plisio/1.0.0/csharp"
        ...
        {
            String report = "C# SDK (IO.Plisio) Debug Report:\n";
